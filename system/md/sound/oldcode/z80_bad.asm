...
Sample_Start	dw (WavIns_SeaLove1&7FFFh)|8000h		; Start
		db WavIns_SeaLove1>>15
Sample_End	dw (WavIns_SeaLove3_e&7FFFh)|8000h	; End
		db WavIns_SeaLove3_e>>15
...
.use_newinst:
	...
	; write FM instrument
		ld	a,(ix+chnl_Chip)
		or	a
		jp	m,.no_newinst		; PSG ins are external
		call	SndDrv_SetIns_FM
.no_newinst:
...
.use_notereq:
		...
		res 	bitChnlSlide,(ix+chnl_Flags)
		ld	b,(ix+chnl_InsType)
		ld	c,(ix+chnl_Chip)
		ld	a,b
		or	a			; Type 080h/0E0h?
...
.eff_D:
		...
		jp	z,.doeff_D		; 00h - slide continue
.go_down:
		cpl
		inc	a
...
.set_portam:
		...
		set	bitChnlSlide,(ix+chnl_Flags)
...
chnl_FmPan	equ 0Fh
chnl_FmRegB0	equ 10h
chnl_FmRegB4	equ 11h
chnl_FmRegKeys	equ 12h
chnl_PsgVolBase	equ 13h
chnl_PsgVolEnv	equ 14h
chnl_PsgIndx	equ 15h
chnl_SmplFlags	equ 16h
chnl_EfVolSlide	equ 17h
chnl_EfNewVol	equ 18h

chnl_SmplFreq	equ 19h		; word
chnl_EfPortam	equ 1Bh		; word
chnl_EfNewFreq	equ 1Dh		; word
